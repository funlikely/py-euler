...
"""
from utilities.prime_decomposition import *
...
def get_distinct_power_count(a_interval, b_interval):
    ...
    for a in range(a_min, a_max + 1):
        for b in range(b_min, b_max + 1):
            prime_decomposition = PrimeDecomposition(a)
            powered = prime_decomposition.powerify(b)
            if powered not in distinct_powers:
                distinct_powers.append(powered)
...
def main():
    ...
    # The Answer to Project Euler 029 is 9183
