...
def get_pandigital_numbers2():
    """
        First solution. before I rememberd that one could use str() on an integer.
    :return:
    """
    pandigital_numbers = []
...
def main():
    answer = get_pandigital_numbers2()
