...
def get_max_path_sum():
    pyramid = [[75], [95, 64], [17, 47, 82], [18, 35, 87, 10], [20, 4, 82, 47, 65], [19, 1, 23, 75, 3, 34],
...
def main():
    ...
    print(f"The Answer to Project Euler 018 is {answer}")

    # The Answer to Project Euler 018 is 1074
