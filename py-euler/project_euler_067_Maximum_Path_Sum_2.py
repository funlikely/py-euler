...
def get_pyramid():
    f = open('data/project_euler_067.txt')
    lines = f.readlines()
    pyramid = []
    for line in lines:
        pyramid.append([int(s) for s in line.split(' ')])
    return pyramid
...
def main():
    ...
    answer = get_max_path_sum()
    print(f"The Answer to Project Euler 067 is {answer}")

    # The Answer to Project Euler 067 is 7273
